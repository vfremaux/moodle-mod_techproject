...
/**
 * mod_techproject requirement cleared event.
 *
...
class requirement_cleared extends \core\event\base {
    /**
    ...
    public function get_description() {
        return 'All requirements of group '.$this->groupid.' in techproject '.$this->contextinstanceid.' have been cleared.';
    }
    ...
    public static function get_name() {
        return get_string('event_requs_cleared', 'mod_techproject');
    }
