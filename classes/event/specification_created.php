...
class specification_created extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The specification $this->objectid in techproject " . $this->contextinstanceid . " has been created.";
    }
    ...
    public static function get_name() {
        return get_string('event_specification_created', 'mod_techproject');
    }
