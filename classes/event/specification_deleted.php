...
/**
 * mod_techproject specification created event.
 *
...
class specification_deleted extends \core\event\base {
    /**
    ...
    public static function create_from_specification(\stdClass $techproject, \context_module $context, \stdClass $specification, $groupid) {
        ...
        $event->add_record_snapshot('techproject_specification', $specification);
        return $event;
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'techproject', 'changespec', $this->get_url(), $this->objectid, $this->contextinstanceid);
    }
    ...
    public static function get_name() {
        return get_string('event_specification_updated', 'mod_techproject');
    }
