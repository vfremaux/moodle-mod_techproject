...
class deliverable_created extends \core\event\base {
    /**
    ...
    public static function create_from_deliverable(\stdClass $techproject, \context_module $context, \stdClass $deliverable, $groupid) {
        ...
        $event->add_record_snapshot('techproject_deliverable', $deliverable);
        return $event;
    }
    ...
    public function get_description() {
        return "The deliverable $this->objectid in techproject " . $this->contextinstanceid . " has been created.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'techproject', 'adddeliverable', $this->get_url(), $this->objectid, $this->contextinstanceid);
    }
    ...
    public static function get_name() {
        return get_string('event_deliverable_created', 'mod_techproject');
    }
