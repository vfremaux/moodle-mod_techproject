...
class milestone_created extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The milestone $this->objectid in techproject " . $this->contextinstanceid . " has been created.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'techproject', 'addmile', $this->get_url(), $this->objectid, $this->contextinstanceid);
    }
    ...
    public static function get_name() {
        return get_string('event_milestone_created', 'mod_techproject');
    }
