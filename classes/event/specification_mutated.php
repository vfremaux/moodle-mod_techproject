...
/**
 * mod_techproject speciffication mutated event.
 *
...
class specification_mutated extends \core\event\base {
     ...
     * @param string $idlist
     * @return specification_mutated
     */
    public static function create_from_specification(\stdClass $techproject, \context_module $context, $idlist, $groupid) {
        $data = array(
        ...
        /** @var specification_mutated $event */
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'techproject', 'movecopyspecs', $this->get_url(), 0, $this->contextinstanceid);
    }
    ...
    public static function get_name() {
        return get_string('event_specs_mutated', 'mod_techproject');
    }
