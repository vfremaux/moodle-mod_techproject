...
class requirement_created extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The requirement $this->objectid in techproject " . $this->contextinstanceid . " has been created.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'techproject', 'addrequ', $this->get_url(), $this->objectid, $this->contextinstanceid);
    }
    ...
    public static function get_name() {
        return get_string('event_requirement_created', 'mod_techproject');
    }
