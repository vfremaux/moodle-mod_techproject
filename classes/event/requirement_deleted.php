...
class requirement_deleted extends \core\event\base {
    /**
    ...
    public static function create_from_requirement(\stdClass $techproject, \context_module $context, \stdClass $requirement, $groupid) {
        ...
        $event->add_record_snapshot('techproject_requirement', $requirement);
        return $event;
    }
    ...
    public function get_description() {
        return "The requirement $this->objectid in techproject " . $this->contextinstanceid . " has been deleted.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'techproject', 'deleterequ', $this->get_url(), $this->objectid, $this->contextinstanceid);
    }
    ...
    public static function get_name() {
        return get_string('event_requirement_deleted', 'mod_techproject');
    }
