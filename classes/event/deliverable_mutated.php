...
class deliverable_mutated extends \core\event\base {
    /**
     ...
     */
    public static function create_from_deliverable(\stdClass $techproject, \context_module $context, $idlist, $groupid) {
        $data = array(
    ...
    public function get_description() {
        return "The deliverables $this->idlist in techproject " . $this->contextinstanceid . " has been mutated(moved/copied).";
    }
    ...
    public static function get_name() {
        return get_string('event_delivs_mutated', 'mod_techproject');
    }
