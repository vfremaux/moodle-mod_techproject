...
class task_created extends \core\event\base {
     ...
     */
    public static function create_from_task(\stdClass $techproject, \context_module $context, \stdClass $task, $groupid) {
        $data = array(
    ...
    public function get_description() {
        return "The task $this->objectid in techproject " . $this->contextinstanceid . " has been created.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'techproject', 'addtask', $this->get_url(), $this->objectid, $this->contextinstanceid);
    }
    ...
    public static function get_name() {
        return get_string('event_task_created', 'mod_techproject');
    }
