 ...
 * @topic: 0
 */
function GanttTaskInfo(id, name, est, duration, percentCompleted, predecessorTaskId, assignee, assigneeId, owner, ownerId, quoted, used)
{
    this.Id = id;
    this.Name = name;
    this.EST = est;
...
/**
 * @desc: set working language
 * @param: lang - Lang code (2 chars). will be lowercase.
 * @type: public
 * @topic: 0
 * @before_init: 1
 */
GanttChart.prototype.setLang = function(lang)
{
    this.lang = lang.toLowerCase();
};

/**
 * @desc: get working language
 * @type: public
 * @topic: 0
 * @before_init: 1
 */
GanttChart.prototype.getLang = function(lang)
{
    return this.lang;
};

/**
 * @desc: translation function
 * @type: public
 * @topic: 0
 * @before_init: 1
 */
GanttChart.prototype.t = function(langkey)
{
	if (gantt_i18N[langkey] == undefined){
	    return '[['+langkey+']]';
	}
    return gantt_i18N[langkey];
};
...
GanttProject.prototype.deleteChildTask = function(task)
{
    if (task)
    {
        ...
        this.Chart.callEvent('onTaskDelete', [task]);
...
GanttProject.prototype.insertTask = function(id, name, EST, Duration, PercentCompleted, predecessorTaskId, parentTaskId)
{
    ...
    this.Chart.callEvent('onTaskInsert', [_task]);
...
GanttTask.prototype.setEST = function(est, shiftChild)
{
    ...
    this.maxPosXMove = -1;
    this.minPosXMove = -1;
    this.Chart.callEvent('onTaskChangeEST', [this]);
    return true;
};
/**
...
GanttTask.prototype.setDuration = function(duration)
{
    ...
    } else if (width < this.minWidthResize)
    {
        ...
        this.endResizeItem();
        if (this.Chart.isShowDescTask)this.descrTask.innerHTML = this.getDescStr();
        this.Chart.callEvent('onTaskChangeDuration', [this]);
        return true;
    }
...
GanttTask.prototype.setPercentCompleted = function(percentCompleted)
{
    ...
    this.endResizeItem();
    if (this.Chart.isShowDescTask)this.descrTask.innerHTML = this.getDescStr();
    this.Chart.callEvent('onTaskChangeCompletion', [this]);
    return true;
};
/**
...
GanttTask.prototype.setName = function(name)
{
    ...
    if ((name != "") && (name != null)) {
        ...
        if (this.Chart.isShowDescTask)this.descrTask.innerHTML = this.getDescStr();
        this.addDayInPanelTime();
		this.Chart.callEvent("onTaskRename", [this]);
    }
};
/**
...
GanttChart.prototype.addDayInPanelTime = function(row)
{
	...
	m = date.getMonth();
	d = date.getDate();
	if ((d == currentTime.getDate()) && (m == currentTime.getMonth()) && (y = currentTime.getYear())) {
		newCell.style.backgroundColor = "#CBCEEB";
	}
};
/**
...
GanttTask.prototype.getPopUpInfo = function(object, event)
{
    ...
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>"+this.Chart.t("est")+":&nbsp;</span><span class='ut'>" + this.TaskInfo.EST.getDate() + "." + (this.TaskInfo.EST.getMonth() + 1) + "." + this.TaskInfo.EST.getFullYear() + "</span><br/>";
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>"+this.Chart.t("duration")+":&nbsp;</span><span class='ut'>" + this.TaskInfo.Duration + " "+ this.Chart.t("hours")+" </span><br/>";
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>"+this.Chart.t("assignee")+":&nbsp;</span><span class='ut'>" + this.TaskInfo.Assignee + " </span><br/>";
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>"+this.Chart.t("owner")+":&nbsp;</span><span class='ut'>" + this.TaskInfo.Owner + " </span><br/>";
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>"+this.Chart.t("quote")+":&nbsp;</span><span class='ut'>" + this.TaskInfo.Quote + " </span><br/>";
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>"+this.Chart.t("completion")+":&nbsp;</span><span class='ut'>" + this.TaskInfo.PercentCompleted + "% </span><br/>";

    //show predecessor task
    if (this.predTask)
    {
        tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>"+this.Chart.t("predecessor")+":&nbsp;</span>";
    ...
    if (this.TaskInfo.ChildTasks.length != 0) {
        tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>"+this.Chart.t('childtasks')+":&nbsp;</span>";
    ...
    if (this.TaskInfo.ParentTask) {
        tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>"+this.Chart.t("parenttask")+":&nbsp;</span>";
...
contextMenu.prototype._init = function()
{
    ...
    var tab1 = this.createTab(1, this.Chart.t("renametask"), "t", true, this);
    tab1.addItem(1, this.Chart.t("newname"), document.createElement("input"), "text", function() {
        tab1.arrItems[0].control.focus();
    });
    tab1.addItem(2, this.Chart.t("rename"), document.createElement("input"), "button",
            function() {
    ...
    var tab2 = this.createTab(2, this.Chart.t("deletetask"), "t", true, this);
    tab2.addItem(1, this.Chart.t("delete"), document.createElement("input"), "button",
            function()
            {
                try {
    ...
    var tab3 = this.createTab(3, this.Chart.t("setest"), "t", true, this);
    tab3.addItem(1, this.Chart.t("est"), document.createElement("input"), "text", function() {
        tab3.arrItems[0].control.focus();
    });
    tab3.addItem(2, this.Chart.t("movechldiren"), document.createElement("input"), "checkbox", function() {
        tab3.arrItems[1].control.focus();
    });
    tab3.addItem(3, this.Chart.t("update"), document.createElement("input"), "button",
            function() {
    ...
    var tab4 = this.createTab(4, this.Chart.t("setduration"), "t", true, this);
    tab4.addItem(1, this.Chart.t("duration"), document.createElement("input"), "text", function() {
        tab4.arrItems[0].control.focus();
    });
    tab4.addItem(2, this.Chart.t("update"), document.createElement("input"), "button",
            function() {
    ...
    var tab5 = this.createTab(5, this.Chart.t("setcompletion"), "t", true, this);
    tab5.addItem(1, this.Chart.t("percentcomplete"), document.createElement("input"), "text", function() {
        tab5.arrItems[0].control.focus();
    });
    tab5.addItem(2, this.Chart.t("update"), document.createElement("input"), "button",
            function() {
    ...
    var tab13 = this.createTab(13, this.Chart.t("setpredecessor"), "t", true, this);
    tab13.addItem(1, this.Chart.t("predecessor"), document.createElement("input"), "text", function() {
        tab13.arrItems[0].control.focus();
    });
    tab13.addItem(2, this.Chart.t("update"), document.createElement("input"), "button",
            function() {
    ...
    var tab6 = this.createTab(6, this.Chart.t("renameproject"), "p", true, this);
    tab6.addItem(1, this.Chart.t("newname"), document.createElement("input"), "text", function() {
        tab6.arrItems[0].control.focus();
    });
    tab6.addItem(2, this.Chart.t("rename"), document.createElement("input"), "button",
            function() {
    ...
    var tab7 = this.createTab(7, this.Chart.t("deleteproject"), "p", true, this);
    tab7.addItem(1, this.Chart.t("delete"), document.createElement("input"), "button",
            function() {
                try {
    ...
    var tab8 = this.createTab(8, this.Chart.t("setcompletion"), "p", true, this);
    tab8.addItem(1, this.Chart.t("percentcomplete"), document.createElement("input"), "text", function() {
        tab8.arrItems[0].control.focus();
    });
    tab8.addItem(2, this.Chart.t("update"), document.createElement("input"), "button",
            function() {
    ...
    var tab9 = this.createTab(9, this.Chart.t("addnewtask"), "p", true, this);
    tab9.addItem(1, this.Chart.t("id"), document.createElement("input"), "text", function() {
        tab9.arrItems[0].control.focus();
    });
    tab9.addItem(2, this.Chart.t("name"), document.createElement("input"), "text", function() {
        tab9.arrItems[1].control.focus();
    });
    tab9.addItem(3, this.Chart.t("est"), document.createElement("input"), "text", function() {
        tab9.arrItems[2].control.focus();
    });
    tab9.addItem(4, this.Chart.t("duration"), document.createElement("input"), "text", function() {
        tab9.arrItems[3].control.focus();
    });
    tab9.addItem(5, this.Chart.t("percentcomplete"), document.createElement("input"), "text", function() {
        tab9.arrItems[4].control.focus();
    });
    tab9.addItem(6, this.Chart.t("parenttaskid"), document.createElement("input"), "text", function() {
        tab9.arrItems[5].control.focus();
    });
    tab9.addItem(7, this.Chart.t("predtaskid"), document.createElement("input"), "text", function() {
        tab9.arrItems[6].control.focus();
    });

    tab9.addItem(9, this.Chart.t("insert"), document.createElement("input"), "button",
            function() {
                try {
    ...
    var tab11 = this.createTab(11, this.Chart.t("addsuccessortask"), "t", true, this);
    tab11.addItem(1, this.Chart.t("id"), document.createElement("input"), "text", function() {
        tab11.arrItems[0].control.focus();
    });
    tab11.addItem(2, this.Chart.t("name"), document.createElement("input"), "text", function() {
        tab11.arrItems[1].control.focus();
    });
    tab11.addItem(3, this.Chart.t("est"), document.createElement("input"), "text", function() {
        tab11.arrItems[2].control.focus();
    });
    tab11.addItem(4, this.Chart.t("duration"), document.createElement("input"), "text", function() {
        tab11.arrItems[3].control.focus();
    });
    tab11.addItem(5, this.Chart.t("completion"), document.createElement("input"), "text", function() {
        tab11.arrItems[4].control.focus();
    });
    tab11.addItem(6, this.Chart.t("insert"), document.createElement("input"), "button",
            function() {
                try {
    ...
    var tab10 = this.createTab(10, this.Chart.t("addchildtask"), "t", true, this);
    tab10.addItem(1, this.Chart.t("id"), document.createElement("input"), "text", function() {
        tab10.arrItems[0].control.focus();
    });
    tab10.addItem(2, this.Chart.t("name"), document.createElement("input"), "text", function() {
        tab10.arrItems[1].control.focus();
    });
    tab10.addItem(3, this.Chart.t("est"), document.createElement("input"), "text", function() {
        tab10.arrItems[2].control.focus();
    });
    tab10.addItem(4, this.Chart.t("duration"), document.createElement("input"), "text", function() {
        tab10.arrItems[3].control.focus();
    });
    tab10.addItem(5, this.Chart.t("completion"), document.createElement("input"), "text", function() {
        tab10.arrItems[4].control.focus();
    });
    tab10.addItem(6, this.Chart.t("insert"), document.createElement("input"), "button",
            function() {
                try {
    ...
    var tab12 = this.createTab(12, this.Chart.t("insertnewproject"), "p", false, this);
    tab12.addItem(1, this.Chart.t("id"), document.createElement("input"), "text", function() {
        tab12.arrItems[0].control.focus();
    });
    tab12.addItem(2, this.Chart.t("name"), document.createElement("input"), "text", function() {
        tab12.arrItems[1].control.focus();
    });
    tab12.addItem(3, this.Chart.t("startdate"), document.createElement("input"), "text", function() {
        tab12.arrItems[2].control.focus();
    });
    tab12.addItem(4, this.Chart.t("insert"), document.createElement("input"), "button",
            function() {
                try {
...
contextMenuTab.prototype.show = function()
{
    ...
    if (this.showObjectInfo)
    {
        if (this.object) {
            if (this.object.constructor == GanttTask) {
                this.insertData(t, this.contextMenu.Chart.t("id"), this.object.TaskInfo.Id);
                this.insertData(t, this.contextMenu.Chart.t("name"), this.object.TaskInfo.Name);
                this.insertData(t, this.contextMenu.Chart.t("duration"), this.object.TaskInfo.Duration + " hrs");
                this.insertData(t, this.contextMenu.Chart.t("completion"), this.object.TaskInfo.PercentCompleted + "%");
                this.insertData(t, this.contextMenu.Chart.t("est"), this.object.TaskInfo.EST.getDate() + "." + (this.object.TaskInfo.EST.getMonth() + 1) + "." + this.object.TaskInfo.EST.getFullYear());
                this.insertData(t, this.contextMenu.Chart.t("predecessor"), this.object.TaskInfo.PredecessorTaskId);
            } else
            {
                this.insertData(t, this.contextMenu.Chart.t("id"), this.object.Project.Id);
                this.insertData(t, this.contextMenu.Chart.t("name"), this.object.Project.Name);
                this.insertData(t, this.contextMenu.Chart.t("startdate"), this.object.Project.StartDate.getDate() + "." + (this.object.Project.StartDate.getMonth() + 1) + "." + this.object.Project.StartDate.getFullYear());
            }
        }
    }
    ...
    b.type = "button";
    b.value = this.contextMenu.Chart.t("cancel");
    b.onclick = function()
    {
        self.hide();
    };
